...
namespace PlantApp.Data.Migrations
{
    ...
    [Migration("20260212220901_AddManyToManyRealtionShipForPlantedAndLog")]
    partial class AddManyToManyRealtionShipForPlantedAndLog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GrowthLogPlanted", b =>
                {
                    ...
                    b.Property<int>("PlantedListId")
                        .HasColumnType("integer")
                        .HasColumnName("planted_list_id");

                    b.HasKey("GrowthLogsId", "PlantedListId");

                    b.HasIndex("PlantedListId");
