...
{
    public Task<ListResponse<PlantExchangeDto>> GetActiveAsync(int page = 1);
    public Task<ListResponse<PlantExchangeDto>> GetActiveFilteredAsync(PlantExchangeFilterDto filter, int page = 1);
