...
): IAnalyticsService
{
    ...
    private async Task<List<GrowthLogActivity>> GetGrowthLogStats(int userId)
    {
        ...
        var allMonthStats = new List<GrowthLogActivity>();
        ...
        for (int i = 0; i < 12; i++)
        {
            ...
            allMonthStats.Add(new GrowthLogActivity
            {
