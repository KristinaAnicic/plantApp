using Plant.Domain.Dtos;
using Plant.Domain.Utils;
using System.Collections.Concurrent;
using System.Text.Json;
using System.Text.RegularExpressions;

namespace Plant.Domain.Services;

public static class PlantDataFetcher
{
    static readonly string mainPath = Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "Plant.Data");
