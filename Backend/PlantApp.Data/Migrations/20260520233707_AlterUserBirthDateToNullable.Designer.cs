...
namespace PlantApp.Data.Migrations
{
    ...
    [Migration("20260520233707_AlterUserBirthDateToNullable")]
    partial class AlterUserBirthDateToNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlantApp.Domain.Dtos.ML.PlantedGrowthLogOverviewDto", b =>
                {
                    b.Property<int>("DaysSincePlanted")
                        .HasColumnType("integer")
                        .HasColumnName("days_since_planted");

                    b.Property<bool>("DroughtResistant")
                        .HasColumnType("boolean")
                        .HasColumnName("drought_resistant");
                    ...
                    b.Property<double>("Hardiness")
                        .HasColumnType("double precision")
                        .HasColumnName("hardiness");
                    ...
                    b.Property<bool>("LowMaintenance")
                        .HasColumnType("boolean")
                        .HasColumnName("low_maintenance");

                    b.PrimitiveCollection<List<int>>("MoistureList")
                        .IsRequired()
                        .HasColumnType("integer[]")
                        .HasColumnName("moisture_list");
                    ...
                    b.Property<double>("ReminderDelay")
                        .HasColumnType("double precision")
                        .HasColumnName("reminder_delay");
                    ...
                    b.PrimitiveCollection<List<int>>("SunlightList")
                        .IsRequired()
                        .HasColumnType("integer[]")
                        .HasColumnName("sunlight_list");

                    b.ToTable((string)null);

                    b.ToView("vw_planted_growth_overview", (string)null);
                });
            ...
            modelBuilder.Entity("PlantApp.Domain.Models.UserRating", b =>
                {
                    ...
                    b.ToTable("user_ratings", t =>
                        {
                            t.HasCheckConstraint("CK_UserRating_Comment_Length", "char_length(\"comment\") BETWEEN 10 AND 500");
                        });
                });
